<template>
    <div class="header">
        <el-row :gutter="0">
            <el-col :span="6">
                ...
                <div class="grid-content blog-logo hide">
                    <a class="blog-nav-icon" href="javascript:" @click="drawer = true" >
                        <i class="iconfont el-icon-ali-nav"></i>
                    </a>
                </div>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="6">
                <div class="grid-content" v-show="$store.state.login">
                    <el-tooltip class="item" effect="dark" content="退出登录" placement="bottom">
                        <img @click="logout" class="avatar" :src="$store.state.user.avatar" alt="">
                    </el-tooltip>
                </div>
                <div class="grid-content" v-show="!$store.state.login">
                    <el-tooltip class="item" effect="dark" content="QQ登录" placement="bottom">
                        <i class="iconfont icon el-icon-ali-qq" @click="login('qq')"></i>
                    </el-tooltip>
                    <el-tooltip class="item" effect="dark" content="Github登录" placement="bottom">
                        <i class="iconfont icon el-icon-ali-github" @click="login('github')" ></i>
                    </el-tooltip>
                </div>
            </el-col>
        </el-row>
